...
<%@pagetemplatearg=title=Verzeichnis-Freigabe hinzufügen%>
<%@session=yes%>
...
<div class="form_reihe">
	<span class="form_label">Freigabeverzeichnis*:</span>
	<span class="form_input"><input class="input_feld" name="dirname" type="text" value="<%=getattr(self.RequestCtx, "server_ip", "")%>" /></span>
</div>
...
<br />* Das Freigabeverzeichnis ist relativ zum Doc-Root anzugeben
